      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "query",
            "description": "When set to `true` (preferred) or legacy integer `1`, excludes built-in teams (Owners, Everyone) from the response. Prefer `exclude_owners_team` when you only want to omit Owners.",
            "required": false,
            "schema": {
              "type": [
                "boolean",
          ...
          {
            "name": "exclude_owners_team",
            "in": "query",
            "description": "When set to `true` (preferred) or legacy integer `1`, excludes the Owners team from the response while keeping the Everyone team.",
            "required": false,
            "schema": {
              "type": [
                "boolean",
